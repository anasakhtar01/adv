  ...
  render() {
    return (
      <div style={{height: 137,paddingBottom: 22}}>
        ...
        <Grid item xs={4}>
        <img src="/adv/assets/abc-logo.png" style={{width:400,padding: "2%",
    paddingLeft: "7%"}}></img>
        </Grid>
        <Grid item xs={8}>
        <Grid item xs={12} style={{paddingTop: 20}}>
        <img src="/adv/assets/tagline.png"></img>
        </Grid>
        <Grid item xs={12} style={{paddingTop: 20}}>
        <div id="nav">
    <ul>
        <li><Link to="/adv/">Home</Link></li>
        <li><Link to="/adv/page">About Us</Link></li>
        <li><Link to="/adv/page">Brands</Link></li>
        <li><a href="#">Grocery</a></li>
        
        <li><a href="#">Malls</a></li>
        <li><Link to="/adv/page">Contact Us</Link></li>
